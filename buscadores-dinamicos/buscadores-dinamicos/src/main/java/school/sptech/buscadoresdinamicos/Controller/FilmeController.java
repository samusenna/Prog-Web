...
//                .findAny();
    ...
    public ResponseEntity<List<Filme>> buscarSomenteIndicados (){
        List<Filme> filmesFiltrado =
                this.filmeRepository.finfByIndicacaoOscarTrue();
...
//                .findAny();
            ...
            int contador = this.filmeRepository.countByIdIndicacaoOscarFalse();
    ...
    public ResponseEntity<List<Filme>> buscarFilmesComCustoAlto ( @PathVariable double custo){
        List<Filme> filmesFiltrado =
                this.filmeRepository.finfByCustoProducaoGreaterThanEqual(custo);
